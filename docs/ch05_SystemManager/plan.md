...
ch05_SystemManager 在三层叠加,**不改 ch04_AgentLoop 的 Agent Loop 控制流**:
...
| 异步并发 | 沿用 ch04_AgentLoop:virtual thread + `SubmissionPublisher`/`Flow` | 与 ch04_AgentLoop 一致,不引入新机制(N2) |
